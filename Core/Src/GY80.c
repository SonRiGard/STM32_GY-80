...
void read_ACC (I2C_HandleTypeDef *I2Cx, GY80_t *DataStruct){
  ...
  DataStruct->Ay = DataStruct->Accel_Y_RAW / 256.0;
  DataStruct->Az = DataStruct->Accel_Z_RAW / 256.0;
}
...
void read_GYRO (I2C_HandleTypeDef *I2Cx, GY80_t *DataStruct){
	...
	DataStruct->Gx = DataStruct->Gyro_X_RAW * 0.00875 ;
	DataStruct->Gy = DataStruct->Gyro_Y_RAW * 0.00875 ;
	DataStruct->Gz = DataStruct->Gyro_Z_RAW * 0.00875 ;	
}
...
void Angle_GYRO (I2C_HandleTypeDef *I2Cx, GY80_t *DataStruct){
	...
	DataStruct->Pitch_GYRO += DataStruct->Gx*DeltaT;
	DataStruct->Roll_GYRO += DataStruct->Gy*DeltaT;
	DataStruct->Yaw_GYRO += DataStruct->Gz*DeltaT;
}
void Angle_ACC (I2C_HandleTypeDef *I2Cx, GY80_t *DataStruct){
	read_ACC(&hi2c1, DataStruct);
	DataStruct->Pitch_ACC = atan2((DataStruct->Ay),DataStruct->Az)*RAD_TO_DEG;
	DataStruct->Roll_ACC =atan2(-(DataStruct->Ax), sqrt((DataStruct->Ay)*(DataStruct->Ay)+(DataStruct->Az)*(DataStruct->Az)))*RAD_TO_DEG; 
